...
import com.oracle.idm.agcs.grc.fn.commons.manager.AuthenticationManager;
...
public class Util {
  ...
  public static final String applicationConfigFilePath =
      "/request/applications/<APPLICATION_NAME>/config.yaml";
  public static final String templateJsonFilePath =
      "/request/applications/<APPLICATION_NAME>/<ENTITY_NAME>/<OPERATION_NAME>_TEMPLATE.json";
  public static final String membershipAttributeTemplateJsonFilePath =
      "/request/applications/<APPLICATION_NAME>/<ENTITY_NAME>/<MEMBERSHIP_ATTRIBUTE_NAME>/<OPERATION_NAME>_TEMPLATE.json";
  ...
  public static ApplicationConfig getApplicationConfigForConnectedSystemName(
    ...
    if (null == applicationConfiguration) {
      System.err.println(
          String.format(
              "RequestTemplateFunction input connectedSystemName %s is invalid",
              connectedSystemName));
      throw new BadRequestException(
          String.format(
              "RequestTemplateFunction input connectedSystemName %s is invalid",
  ...
  public static RequestTemplateOutput getTemplateWithAuthorizationToken(
    ...
    replaceUriSchemeValue(
        templateOutputFromResources,
        connectedSystemConfig.getApplicationInstanceDetail().get("scheme"));
    replaceUriHostValue(
        templateOutputFromResources,
        connectedSystemConfig.getApplicationInstanceDetail().get("host"));
